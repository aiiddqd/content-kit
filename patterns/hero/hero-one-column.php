<?php
/**
 * Title: One column, Image, heading, text, buttons
 * Slug: ck/general-hero-one-column
 * Categories: ck-hero
 */
...
<figure class="wp-block-image size-full"><img src="<?= $media_url ?>" alt="Sample Image" class="wp-image-3480"/></figure>
<!-- /wp:image -->
